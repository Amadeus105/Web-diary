  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        borderRadius: "24px", border: "1px solid var(--block-border)",
        padding: "40px", boxShadow: "0 8px 40px rgba(0,0,0,0.12)",
      }}>

        {/* Logo */}
        <div style={{ textAlign: "center", marginBottom: "32px" }}>
          <div style={{ fontSize: "40px", marginBottom: "8px" }}>🌐</div>
          <h2 style={{ color: "var(--text-color)", fontWeight: "800", fontSize: "24px", margin: 0, letterSpacing: "-0.5px" }}>
            Web Diary
          </h2>
          <p style={{ color: "var(--text-color)", opacity: 0.5, fontSize: "14px", margin: "6px 0 0 0" }}>
        ...
        {error && (
          <div style={{
            ...
            marginBottom: "20px", color: "#ef4444", fontSize: "14px",
          }}>
            ⚠️ {error}
          </div>
        )}
        ...
        <form onSubmit={handleSubmit}>
          <div style={{ marginBottom: "16px" }}>
            <label style={{
              display: "block", color: "var(--text-color)", opacity: 0.7,
              fontSize: "13px", fontWeight: "600", marginBottom: "6px", letterSpacing: "0.3px"
            }}>USERNAME</label>
            <input
        ...
        <p style={{
          ...
          color: "var(--text-color)", opacity: 0.6, fontSize: "14px", margin: "24px 0 0 0"
        }}>
          {isRegister ? "Already have an account?" : "Don't have an account?"}{" "}
          <span
            onClick={() => { setIsRegister(!isRegister); setError(""); }}
            style={{ color: "#7c3aed", cursor: "pointer", fontWeight: "600", opacity: 1 }}
          >
